...
/** Mapeia nome completo do estado → sigla (UF). Usado quando o user escolhe
 *  estado manualmente no LocationModal — derivamos a sigla pra mostrar no
 *  header (`Atendendo Acrelândia - AC`) e persistir junto com a cidade. */
export const stateCodeByName: Record<string, string> = {
  Acre: "AC",
  Alagoas: "AL",
  Amapá: "AP",
  Amazonas: "AM",
